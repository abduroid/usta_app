...
/**
 * Usta_app view toggle button with included trailing icon as well as compact and expanded
...
fun UstaViewToggleButton(
    ...
    TextButton(
        ...
        contentPadding = UstaViewToggleDefaults.ViewToggleButtonContentPadding,
    ) {
        UstaViewToggleButtonContent(
            text = if (expanded) expandedText else compactText,
            trailingIcon = {
                Icon(
                    imageVector = if (expanded) UstaIcons.ViewDay else UstaIcons.ShortText,
...
/**
 * Internal Usta_app view toggle button content layout for arranging the text label and
 * trailing icon.
 *
 ...
 */
@Composable
private fun UstaViewToggleButtonContent(
...
/**
 * Usta_app view toggle default values.
 */
object UstaViewToggleDefaults {
    // TODO: File bug
